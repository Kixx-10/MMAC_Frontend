...
import 'package:mmac/ui/views/widgets/health_record_upload_widget.dart';
import '../../../../utils/form_validators.dart';
      ...
      children: [
        ...
        _DeclarationQuestion(
          ...
          onChanged: (val) {
            widget.onValueChanged('hasSymptoms', val);
            if (val != 'Yes') {
              // Clear the stored URL on the form...
              widget.onValueChanged('healthRecordUrl', null);
              // ...and reset the upload widget's own state so a stale
              // "uploaded" chip doesn't linger if they switch back to 'Yes'.
